...
SECRET_KEY = 'd6(5r2be39ck1pv7s3v#s5b1#*x_0p(tpn-ghvn_=f32a389=g'
...
ALLOWED_HOSTS = ['api.meiduo.site', '127.0.0.1']  # 表示可以用域名来访问
...
QQ_REDIRECT_URI = 'http://www.meiduo.site:8080/oauth_callback.html'  # 登录成功后的跳转链接
...
EMAIL_USE_TLS = True
# 发送邮件的邮箱
EMAIL_HOST_USER = 'mr__bian@163.com'
# 在邮箱中设置的客户端授权密码
EMAIL_HOST_PASSWORD = 'bxj123'
# 收件人看到的发件人
EMAIL_FROM = 'meiduo<mr__bian@163.com>'
